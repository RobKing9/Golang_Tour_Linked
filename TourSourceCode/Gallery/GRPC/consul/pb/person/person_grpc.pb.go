...
type SayHelloClient interface {
	Greet(ctx context.Context, in *Person, opts ...grpc.CallOption) (*Person, error)
}
...
func (c *sayHelloClient) Greet(ctx context.Context, in *Person, opts ...grpc.CallOption) (*Person, error) {
	out := new(Person)
	err := c.cc.Invoke(ctx, "/pb.SayHello/greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SayHelloServer interface {
	Greet(context.Context, *Person) (*Person, error)
...
func (UnimplementedSayHelloServer) Greet(context.Context, *Person) (*Person, error) {
...
func _SayHello_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Person)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SayHelloServer).Greet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.SayHello/greet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayHelloServer).Greet(ctx, req.(*Person))
	}
...
var SayHello_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "greet",
			Handler:    _SayHello_Greet_Handler,
		},
	},
